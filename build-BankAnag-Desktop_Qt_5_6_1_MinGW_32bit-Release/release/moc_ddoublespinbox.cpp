...
#include "../../BankAnag/DesignWidgets/ddoublespinbox.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DDoubleSpinBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DDoubleSpinBox_t qt_meta_stringdata_DDoubleSpinBox = {
    {
QT_MOC_LITERAL(0, 0, 14) // "DDoubleSpinBox"
...
const QMetaObject DDoubleSpinBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DDoubleSpinBox.data,
      qt_meta_data_DDoubleSpinBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DDoubleSpinBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DDoubleSpinBox.stringdata0))
        return static_cast<void*>(const_cast< DDoubleSpinBox*>(this));
