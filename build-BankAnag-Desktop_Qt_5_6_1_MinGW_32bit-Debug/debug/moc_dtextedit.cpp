...
#include "../../BankAnag/DesignWidgets/dtextedit.h"
...
struct qt_meta_stringdata_DTextEdit_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DTextEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DTextEdit_t qt_meta_stringdata_DTextEdit = {
    {
QT_MOC_LITERAL(0, 0, 9) // "DTextEdit"
...
const QMetaObject DTextEdit::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DTextEdit.data,
      qt_meta_data_DTextEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DTextEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DTextEdit.stringdata0))
